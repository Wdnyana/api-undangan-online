...
class UndanganService {
    createUndangan(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existingUndangan = yield prisma_1.default.undangan.findFirst({
                where: { namaundangan },
            });
            if (existingUndangan) {
                throw new Error("Nama undangan sudah tersedia.");
            }
            const newUndangan = yield prisma_1.default.undangan.create({
                data: { namaundangan },
            });
            return newUndangan;
        });
    ...
    getAllUndangans() {
        return __awaiter(this, void 0, void 0, function* () {
            const undangans = yield prisma_1.default.undangan.findMany();
            return undangans;
        });
    }
}
